...
for (( i=1; i<=2; i++ ))
do
	echo "# Executing: ssu-align -b 50 --dna --rfonly ssu_aln/DADA2seqs.fasta.$i ssu_aln/ssu_aln.$i > /dev/null &"
	ssu-align -b 50 --dna --rfonly ssu_aln/DADA2seqs.fasta.$i ssu_aln/ssu_aln.$i > /dev/null &
done
echo "# Executing: ssu-align --merge 3 -b 50 --dna --rfonly ssu_aln/DADA2seqs.fasta.3 ssu_aln/ssu_aln.3"
ssu-align --merge 3 -b 50 --dna --rfonly ssu_aln/DADA2seqs.fasta.3 ssu_aln/ssu_aln.3
